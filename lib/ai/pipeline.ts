  ...
  const userPrompt =
    REPORT_LOCALE === "en"
      ? [
          ...
          "  - daily_overview: **150-250 word** paragraph covering tech / politics signals so a reader sees the whole picture at a glance",
      ...
      : [
          ...
          "  - daily_overview: **150-220 字** 的当日总览段落，一段话覆盖技术 / 时政 的核心信号，让读者一眼抓住全貌",
