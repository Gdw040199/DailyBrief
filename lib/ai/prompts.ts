...
输出严格遵循以下 JSON Schema：
{
  ...
  "daily_overview": string,          // 150-220 字的当日总览段落（一段话凝练技术与时政要点，让读者 30 秒抓住全局）
...
8. tech_briefs 中遇到 GitHub Trending / arXiv 论文类项目时，可在 summary 多花
   20-40 字解释这个项目/论文实际做什么、为何值得关注（解决了什么问题、用了什么技术），
...
Output STRICTLY follows this JSON schema:
{
  ...
  "daily_overview": string,          // 150-250 word paragraph distilling tech / politics signals so a reader catches the whole picture in 30 seconds
...
8. For GitHub Trending / arXiv paper items in tech_briefs, spend an extra 20-40 words in the summary explaining what the project/paper actually does and why it's worth noting (problem solved, tech used). Readers usually haven't heard of these.`;
